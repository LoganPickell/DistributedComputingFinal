...
public class ThirdPersonController : NetworkBehaviour
{
    ...
    void Start()
    {
        ...
        if (!IsHost)
        {
            transform.position = new Vector3(-1.561168f, 0.4678909f, -0.005118251f);
        }
    ...
    private Vector3 secondPlayerSpawnPosition = new Vector3(-1.56116772f, 0.467890859f, -0.00511825085f);
    private void OnClientConnected()
    {
        if (!IsHost)
        {
            transform.position = secondPlayerSpawnPosition;
        }
